...
require JPATH_COMPONENT_ADMINISTRATOR . '/helpers/accesskeys.php';
...
<form action="<?php echo JRoute::_('index.php?option=com_accesskeys');?>" method="post" name="adminForm" id="adminForm">
    ...
    <div id="filter-bar" class="btn-toolbar">
            ...
            <div class="btn-group pull-right">
                ...
                <select name="menutype" class="input-medium" onchange="this.form.submit()">
		...
		<tr class="<?php echo "row$k"; ?>">
            ...
            <td>
                <?php
                    ...
                    if($row->id == $this->ak_record ){
                        ?>Alt + Shift + <input type="hidden" id="cid_<?php echo $this->ak_record ?>"  name="cid[]" value="<?php echo $this->ak_record ?>"/>
                        <input type="text" style="width:40px;height:25px;" size="1" name="accesskey" value="<?php echo $row->accesskey ?>" />&nbsp;
                        <button type="submit" class="ak_ok" onclick="$('task').value='accesskey.save';"><?php echo JText::_( 'Save' )?></button>&nbsp;
                        <button type="button" onclick="window.location.href='index.php?option=com_accesskeys'"  class="ak_ko"><?php echo JText::_( 'Cancel' )?></button>
                <?php
                    }
                    else
                    {
