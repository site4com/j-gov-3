...
<div class="item-page<?php echo $this->pageclass_sfx; ?>"  >
	<meta  content="<?php echo ($this->item->language === '*') ? JFactory::getConfig()->get('language') : $this->item->language; ?>" />
...
?>
	<?php if (!$useDefList && $this->print) : ?>
		...
		<div class="hidden-print">
			<a class="accessible" href="javascript:void(0)" onclick="window.close()"><?php echo JText::_('JSKIP') ?></a> | 
			<a class="accessible" href="<?php echo JUri::base(); ?>" ><?php echo JText::_('JHOME') ?></a>
		</div>
